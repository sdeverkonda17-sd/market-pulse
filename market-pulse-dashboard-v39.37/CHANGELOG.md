...
## v39.37 — 2 September 2026

- Separated cash-equity share terminology from futures/options contract-lot terminology.
- Equity results now show shares, price per share, total position cost, stop price and share/total risk.
- Derivative results now show lots, units per lot, total units, unit price and one-lot/total contract values.
- Added a plain-language position summary before the detailed analytical evidence.
